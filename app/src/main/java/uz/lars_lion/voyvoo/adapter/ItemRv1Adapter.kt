...
import uz.lars_lion.voyvoo.databinding.RvItem1Binding
import uz.lars_lion.voyvoo.databinding.RvItemBinding
import uz.lars_lion.voyvoo.model.Person

@SuppressLint("SetTextI18n")
class ItemRv1Adapter(
) : RecyclerView.Adapter<ItemRv1Adapter.CreatePageViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        CreatePageViewHolder(
            RvItem1Binding.inflate(LayoutInflater.from(parent.context)),
            listener
        )
    ...
    constructor(
        private val binding: RvItem1Binding,
